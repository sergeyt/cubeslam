...
// Monkey Patching AudioContext.prototype.createGain
var AC = window.webkitAudioContext || window.mozAudioContext || window.AudioContext;
if (AC && AC.prototype.createGain && !AC.prototype.createGainNode) {
  AC.prototype.createGainNode = AC.prototype.createGain;
}
